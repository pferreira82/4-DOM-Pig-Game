...
*/
var scores, roundScores, activePlayer, gamePlaying, setScore;
...
document.querySelector('.btn-score').addEventListener('click', function() {
    //if(gamePlaying) {
        setScore = window.prompt('Please enter the winning score? (Default is 100)');
        document.querySelector('.btn-score').classList.remove('active');
